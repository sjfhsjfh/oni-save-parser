...
function* parseTypeInfo() {
    const info = yield new parser_1.ReadByteInstruction();
    ...
    if (type === type_templates_1.SerializationTypeCode.UserDefined ||
        ...
        const userTypeName = yield new parser_1.ReadKleiStringInstruction();
    ...
    if (info & type_templates_1.SerializationTypeInfo.IS_GENERIC_TYPE) {
        ...
        const subTypeCount = yield new parser_1.ReadByteInstruction();
